...
func (pq *PostQuery) FirstID(ctx context.Context) (id types.UserID, err error) {
...
func (pq *PostQuery) FirstIDX(ctx context.Context) types.UserID {
...
func (pq *PostQuery) OnlyID(ctx context.Context) (id types.UserID, err error) {
	var ids []types.UserID
...
func (pq *PostQuery) OnlyIDX(ctx context.Context) types.UserID {
...
func (pq *PostQuery) IDs(ctx context.Context) (ids []types.UserID, err error) {
...
func (pq *PostQuery) IDsX(ctx context.Context) []types.UserID {
	ids, err := pq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (pq *PostQuery) loadUser(ctx context.Context, query *UserQuery, nodes []*Post, init func(*Post), assign func(*Post, *User)) error {
	...
	nodeids := make(map[types.UserID][]*Post)
	for i := range nodes {
		fk := nodes[i].UserID

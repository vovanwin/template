...
func (*Post) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case post.FieldTest, post.FieldTitle, post.FieldTitle1, post.FieldTitle3:
			values[i] = new(sql.NullString)
		case post.FieldDeletedAt, post.FieldUpdatedAt, post.FieldCreatedAt:
...
func (po *Post) String() string {
	...
	builder.WriteString(po.Test)
	builder.WriteString(", ")
	builder.WriteString("title=")
	builder.WriteString(po.Title)
	builder.WriteString(", ")
	builder.WriteString("title1=")
	builder.WriteString(po.Title1)
	builder.WriteString(", ")
	builder.WriteString("title3=")
	builder.WriteString(po.Title3)
	builder.WriteString(", ")

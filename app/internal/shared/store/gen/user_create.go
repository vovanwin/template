...
func (uc *UserCreate) SetID(ti types.UserID) *UserCreate {
	uc.mutation.SetID(ti)
	return uc
}

// SetNillableID sets the "id" field if the given value is not nil.
func (uc *UserCreate) SetNillableID(ti *types.UserID) *UserCreate {
	if ti != nil {
		uc.SetID(*ti)
	}
	return uc
...
func (u *UserUpsertOne) ID(ctx context.Context) (id types.UserID, err error) {
...
func (u *UserUpsertOne) IDX(ctx context.Context) types.UserID {
	id, err := u.ID(ctx)
	if err != nil {
		panic(err)
	}

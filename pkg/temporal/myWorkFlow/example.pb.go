...
// 	protoc        (unknown)
// source: myWorkFlow/example.proto
...
func (Foo_Status) Descriptor() protoreflect.EnumDescriptor {
	return file_myWorkFlow_example_proto_enumTypes[0].Descriptor()
}

func (Foo_Status) Type() protoreflect.EnumType {
	return &file_myWorkFlow_example_proto_enumTypes[0]
}
...
func (Foo_Status) EnumDescriptor() ([]byte, []int) {
	return file_myWorkFlow_example_proto_rawDescGZIP(), []int{2, 0}
}
...
func (x *CreateFooRequest) Reset() {
	*x = CreateFooRequest{}
	mi := &file_myWorkFlow_example_proto_msgTypes[0]
...
func (*CreateFooRequest) Descriptor() ([]byte, []int) {
	return file_myWorkFlow_example_proto_rawDescGZIP(), []int{0}
}
...
func (x *CreateFooResponse) Reset() {
	*x = CreateFooResponse{}
	mi := &file_myWorkFlow_example_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CreateFooResponse) Descriptor() ([]byte, []int) {
	return file_myWorkFlow_example_proto_rawDescGZIP(), []int{1}
}
...
func (x *Foo) Reset() {
	*x = Foo{}
	mi := &file_myWorkFlow_example_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Foo) Descriptor() ([]byte, []int) {
	return file_myWorkFlow_example_proto_rawDescGZIP(), []int{2}
}
...
func (x *GetFooProgressResponse) Reset() {
	*x = GetFooProgressResponse{}
	mi := &file_myWorkFlow_example_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetFooProgressResponse) Descriptor() ([]byte, []int) {
	return file_myWorkFlow_example_proto_rawDescGZIP(), []int{3}
}
...
func (x *NotifyRequest) Reset() {
	*x = NotifyRequest{}
	mi := &file_myWorkFlow_example_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*NotifyRequest) Descriptor() ([]byte, []int) {
	return file_myWorkFlow_example_proto_rawDescGZIP(), []int{4}
}
...
func (x *SetFooProgressRequest) Reset() {
	*x = SetFooProgressRequest{}
	mi := &file_myWorkFlow_example_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SetFooProgressRequest) Descriptor() ([]byte, []int) {
	return file_myWorkFlow_example_proto_rawDescGZIP(), []int{5}
}
...
var File_myWorkFlow_example_proto protoreflect.FileDescriptor

const file_myWorkFlow_example_proto_rawDesc = "" +
	"\n" +
	"\x18myWorkFlow/example.proto\x12\n" +
	...
	"\n" +
	"example-v1B\x89\x01\n" +
	"\x0ecom.example.v1B\fExampleProtoP\x01Z example/gen/myWorkFlow;examplev1\xa2\x02\x03EXX\xaa\x02\n" +
	"Example.V1\xca\x02\n" +
	"Example\\V1\xe2\x02\x16Example\\V1\\GPBMetadata\xea\x02\vExample::V1b\x06proto3"

var (
	file_myWorkFlow_example_proto_rawDescOnce sync.Once
	file_myWorkFlow_example_proto_rawDescData []byte
)

func file_myWorkFlow_example_proto_rawDescGZIP() []byte {
	file_myWorkFlow_example_proto_rawDescOnce.Do(func() {
		file_myWorkFlow_example_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_myWorkFlow_example_proto_rawDesc), len(file_myWorkFlow_example_proto_rawDesc)))
	})
	return file_myWorkFlow_example_proto_rawDescData
}

var file_myWorkFlow_example_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_myWorkFlow_example_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_myWorkFlow_example_proto_goTypes = []any{
...
var file_myWorkFlow_example_proto_depIdxs = []int32{
...
func init() { file_myWorkFlow_example_proto_init() }
func file_myWorkFlow_example_proto_init() {
	if File_myWorkFlow_example_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_myWorkFlow_example_proto_rawDesc), len(file_myWorkFlow_example_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_myWorkFlow_example_proto_goTypes,
		DependencyIndexes: file_myWorkFlow_example_proto_depIdxs,
		EnumInfos:         file_myWorkFlow_example_proto_enumTypes,
		MessageInfos:      file_myWorkFlow_example_proto_msgTypes,
	}.Build()
	File_myWorkFlow_example_proto = out.File
	file_myWorkFlow_example_proto_goTypes = nil
	file_myWorkFlow_example_proto_depIdxs = nil
}
